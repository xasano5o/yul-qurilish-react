...
import {  useGetCertifcatIDQuery } from "../../redux/slice/category/index.js";
import Modal from "../generic/Modal.jsx";
import { MdDeleteOutline } from "react-icons/md";
import { PiCertificateThin } from "react-icons/pi";
import { useCreateCertifcatIDMutation } from "../../redux/slice/certifcat/index.js";

export default function CertifcatCom({ ID, }) {
    const [isOpen, setIsOpen] = useState(false);
    const closeModal = () => setIsOpen(!isOpen);
    const [deleteTeacher, { isLoading }] = useGetCertifcatIDQuery();
            ...
            {isOpen && (
                ...
                >
                    <div className="py-5 px-10">
                        <h1 className="text-2xl font-bold text-gren-600">
                           Certifcatga olishga rozimisiz !!!
                        </h1>
                    </div>
                </Modal>
            )}
